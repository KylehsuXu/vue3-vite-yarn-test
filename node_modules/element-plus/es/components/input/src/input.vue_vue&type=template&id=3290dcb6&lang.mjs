import { createElementVNode, resolveComponent, openBlock, createElementBlock, normalizeClass, normalizeStyle, createCommentVNode, Fragment, renderSlot, mergeProps, createBlock, withCtx, resolveDynamicComponent, withModifiers, createVNode, toDisplayString } from 'vue';
...
const _hoisted_7 = /* @__PURE__ */ createElementVNode("view", null, null, -1);
const _hoisted_8 = {
  key: 3,
    ...
    _ctx.type !== "textarea" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
      ...
      _ctx.suffixVisible ? (openBlock(), createElementBlock("span", _hoisted_5, [
        createElementVNode("span", _hoisted_6, [
          ...
          _ctx.isWordLimitVisible ? (openBlock(), createElementBlock("span", _hoisted_8, [
            createElementVNode("span", _hoisted_9, toDisplayString(_ctx.textLength) + " / " + toDisplayString(_ctx.attrs.maxlength), 1)
          ])) : createCommentVNode("v-if", true)
        ]),
        _ctx.validateState ? (openBlock(), createBlock(_component_el_icon, {
          key: 0,
      ...
      _ctx.$slots.append ? (openBlock(), createElementBlock("div", _hoisted_10, [
      ...
      _ctx.isWordLimitVisible ? (openBlock(), createElementBlock("span", _hoisted_12, toDisplayString(_ctx.textLength) + " / " + toDisplayString(_ctx.attrs.maxlength), 1)) : createCommentVNode("v-if", true)
    ], 64))
  ], 38);
}
